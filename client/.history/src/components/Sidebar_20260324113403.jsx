...
const Sidebar = ({
  ...
  return (
    <aside
      className={`absolute inset-y-0 left-0 z-40 h-full w-full max-w-full shrink-0 transform border-r border-slate-200/80 bg-white/95 backdrop-blur-xl transition duration-300 md:static md:z-0 md:w-[300px] md:translate-x-0 md:rounded-[28px] md:border md:bg-white/78 lg:w-[320px] xl:w-[360px] ${
