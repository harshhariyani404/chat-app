        ...
        >
          ...
          >
            {getAttachmentKind(previewAttachment) === "image" && (
              <img src={previewAttachment.url} alt="Preview" className="max-h-[90vh] max-w-[90vw] object-contain" />
            )}
            {getAttachmentKind(previewAttachment) === "video" && (
              <video src={previewAttachment.url} controls autoPlay className="max-h-[90vh] max-w-[90vw] rounded-lg bg-black" />
            )}
            {getAttachmentKind(previewAttachment) === "pdf" && (
              <iframe src={previewAttachment.url} className="h-[90vh] w-[90vw] rounded-xl bg-white" title="PDF Preview" />
            )}
            {getAttachmentKind(previewAttachment) === "file" && (
              <div className="flex flex-col items-center rounded-3xl bg-white p-10 shadow-2xl">
                ...
                <a
                  ...
                  className="rounded-xl bg-sky-500 px-8 py-3 font-semibold text-white shadow-md transition hover:bg-sky-600"
                >
                  Download File
                </a>
              </div>
